...
function PrivacyPolicy() {
  return (<main> <h2 className="text-3xl font-black text-center">Privacy Policy</h2> <p className="my-4 text-lg text-center">
    ...
    <p>
      ...
      <a className="ml-1 underline" href="https://al.jacktheflap.com/share/t0lkVDbnacRxAPB1/compound-interest-calculator.jacktheflap.com">click here</a>. No cookies are used and no personal data—not even an IP address or browser user agent—is
